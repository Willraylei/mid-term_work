...
public class NotesList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // setBackgroundResource(R.drawable.app_notes);
        //设置背景
      // setBackgroundMenu();
...
//END_INCLUDE(copy)
    ...
    private void setBackgroundMenu() {
        ...
        //set colorArray of background

        final int[] colorArray={

                Color.parseColor("#abed65"),//Green
                Color.parseColor("#33a9e1"),//Blue
        };
        appBackground = getSharedPreferences("noteapp", MODE_PRIVATE);
        NoteAttribute.snoteBackground=appBackground.getInt(NoteAttribute.NOTEBACKGROUND,colorArray[0]);//default color is green
        listView.setBackgroundColor(NoteAttribute.snoteBackground);
        //change FloatingActionButton background

        final int[] coseArray={
                R.drawable.cose3,
                R.drawable.cose4
        };
        NoteAttribute.scolorselecticon=appBackground.getInt(NoteAttribute.COLORSELECTICON,coseArray[0]);
...
// repeat many times:
        ...
        for(int i=0;i<backdrawableArray.length;i++){
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //make the background color add to the ShardPreferences
                    appBackground
                            .edit()
        ...
        //let the menuBuilder connect to the actionButton
